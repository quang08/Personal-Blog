      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-7 col-span-1 text-xl leading-relaxed">
          ...
          <p className="mt-10">
            ...
            <div className="mt-4">
              Today, I'm a Computer Science undergraduate. I love to build applications, coffee talks and play basketball.
            </div>
          </p>
        </div>
        <div className="lg:col-span-5 col-span-1 ml-10">
          <div className="lg:sticky relative top-8 m-10">
            ...
            />
            <div className="text-xl mt-10 w-3/5">
              <div className="mb-2">
                <a href="https://github.com/quang08" target="_blank">
                  ...
                  <p className="inline">Follow on Github</p>
                </a>
              </div>
              ...
              <div className="mb-2">
                ...
                >
                  ...
                  <p className="inline ">Follow on LinkedIn</p>
                </a>
              </div>
              ...
              <div className="mb-2">
                ...
                >
                  ...
                  <p className="inline">Follow on Instagram</p>
                </a>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <p className="inline">Follow on Facebook</p>
                </a>
              </div>
            </div>
            ...
            <div className="mt-4 border-t-4">
              <div className="mt-4 text-xl">
                ...
                <span className="inline">nguyenthequang080203@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
