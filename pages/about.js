  ...
  return (
    <div className="container mx-auto px-10 mb-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:visible invisible lg:col-span-5 col-span-1 ml-10 rounded-lg dark:bg-white dark:text-black">
            ...
            <div className="text-xl mt-10">
              <div className="mb-2 dark:text-white">
                ...
                >
                  ...
                  <p className="align-middle inline dark:text-black">
                    Follow on Github
                  </p>
                </a>
              </div>
