  ...
  return (
    <div className="container mx-auto px-10 mb-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-7 col-span-1 text-xl leading-relaxed">
          <div className="flex justify-center">
            <Image
              ...
              width={360}
              height={360}
              className="rounded-lg mb-2 lg:hidden"
            />
          </div>
        ...
        <div className="lg:hidden text-xl mt-10 w-full p-8 rounded-lg bg-white shadow-lg dark:bg-neutral-800 dark:shadow-lg dark:shadow-neutral-700 dark:text-gray-400">
          <div className="mb-2 hover:-translate-y-1 transition duration-300 hover:text-teal-400">
            ...
            >
              ...
              <p className="align-middle inline">Follow on Github</p>
            </a>
          </div>
          ...
          <div className="mb-2 hover:-translate-y-1 transition duration-300 hover:text-teal-400">
            ...
            >
              ...
              <p className=" align-middle inline ">Follow on LinkedIn</p>
            </a>
          </div>
          ...
          <div className="mb-2 hover:-translate-y-1 transition duration-300 hover:text-teal-400">
            ...
            >
              ...
              <p className="align-middle inline">Follow on Instagram</p>
            </a>
          </div>
          ...
          <div className="hover:-translate-y-1 transition duration-300 hover:text-teal-400">
            ...
            >
              ...
              <p className="align-middle inline">Follow on Facebook</p>
            </a>
          </div>
            ...
            <div className="text-xl mt-10">
              <div className="mb-2 hover:-translate-y-1 transition duration-300 hover:text-teal-400">
                ...
                >
                  ...
                  <p className="align-middle inline hidden xl:inline-flex">
                    Follow on Github
                  </p>
                  <p className="align-middle inline xl:hidden">Github</p>
                </a>
              </div>
              ...
              <div className="mb-2 hover:-translate-y-1 transition duration-300 hover:text-teal-400">
                ...
                >
                  ...
                  <p className="align-middle inline xl:hidden">LinkedIn</p>
                </a>
              </div>
              ...
              <div className="mb-2 hover:-translate-y-1 transition duration-300 hover:text-teal-400">
                ...
                >
                  ...
                  <p className="align-middle inline xl:hidden">Instagram</p>
                </a>
              </div>
              ...
              <div className="hover:-translate-y-1 transition duration-300 hover:text-teal-400">
                ...
                >
                  ...
                  <p className="align-middle inline xl:hidden">Facebook</p>
                </a>
              </div>
            </div>
